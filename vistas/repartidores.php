<?php
    ...
    $controlador = new RepartidorControlador();
    $repartidores = $controlador->mostrarRepartidores();
    ...
    if (isset($_POST['submit'])) {
        ...
        $controlador->registrar($nombres, $apellidos, $email, $password, $celular, $tipo, $dni_ruc, $tipo_transporte, $placa);
    ...
    if (isset($_POST['update'])) {
        ...
        $controlador->actualizarRepartidor($id, $nombres, $apellidos, $email, $celular, $tipo, $dni_ruc, $tipo_transporte, $placa);
...
<div>
                ...
                <form id="crearForm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tipo" name="tipo" value="Repartidor" readonly>
                        </div>
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editarModal" tabindex="-1" aria-labelledby="editarModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="editarModalLabel">Editar Repartidor</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="editarForm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="editTipo" name="tipo" value="Repartidor" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="editTipoTransporte" class="form-label">Tipo de Transporte</label>
                            <input type="text" class="form-control" id="editTipoTransporte" name="tipo_transporte" required>
                        </div>
                        <div class="mb-3">
        ...
        <table class="table table-bordered table-striped">
            <thead class="table-dark">
                <tr>
                    ...
                    <th class="text-center" scope="col">Tipo Transporte</th>
            ...
            <?php foreach ($repartidores as $repartidor): ?>
                <tr>
                    ...
                    <td class="text-center"><?php echo $repartidor['nombres']; ?></td>
                    <td class="text-center"><?php echo $repartidor['apellidos']; ?></td>
                    <td class="text-center"><?php echo $repartidor['email']; ?></td>
                    <td class="text-center"><?php echo $repartidor['celular']; ?></td>
                    <td class="text-center"><?php echo $repartidor['tipo']; ?></td>
                    <td class="text-center"><?php echo $repartidor['dni_ruc']; ?></td>
                    <td class="text-center"><?php echo $repartidor['tipo_transporte']; ?></td>
                    <td class="text-center"><?php echo $repartidor['placa']; ?></td>
                    ...
                    <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#editarModal">
