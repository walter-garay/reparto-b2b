...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "<script>alert('Solicitud de delivery enviada con éxito.');</script>";
    echo count($datos);
...
<div class="d-flex flex-column justify-content-center align-items-center w-100 h-100">
    <div class="container m-10 rounded-4 shadow-sm col-lg-6 col-md-12 p-4" style="background-color: white;">    <h2 class="mb-4 fs-5">Solicitud de delivery</h2>
            ...
            <div class="tab-pane fade show active" id="step1" role="tabpanel" aria-labelledby="step1-tab">
                ...
                <div class="mb-3 d-flex flex-column">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="tipo_contraentrega" id="no_cobrar" value="no_cobrar" checked>
                        <label class="form-check-label" for="no_cobrar">No cobrar</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="tipo_contraentrega" id="solo_pedido" value="solo_pedido">
                        <label class="form-check-label" for="solo_pedido">Solo valor del pedido</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="tipo_contraentrega" id="solo_delivery" value="solo_delivery">
                        <label class="form-check-label" for="solo_delivery">Solo delivery</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="tipo_contraentrega" id="cobrar_ambos" value="cobrar_ambos">
            ...
            <div class="tab-pane fade" id="step5" role="tabpanel" aria-labelledby="step5-tab">
                ...
                <div class="mb-3">
                    ...
                    <select name="metodo_pago" class="form-select" aria-label="Seleccionar tu método de pago preferido">
                        <option value="Yape / Plin" selected>Yape / Plin</option>
